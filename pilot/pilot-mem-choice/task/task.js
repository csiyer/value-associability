...
if (params.stim_type === 'memorability') {
    STIM_LISTS.highmem = Array.from({ length: 102 }, (_, i) => `../../pilot-stimuli/highmem/highmem_${i + 1}.jpg`);
    STIM_LISTS.lowmem = Array.from({ length: 102 }, (_, i) => `../../pilot-stimuli/lowmem/lowmem_${i + 1}.jpg`);
} else {
    STIM_LISTS.unique = Array.from({ length: 300 }, (_, i) => `../../pilot-stimuli/unique_objects/unique_${i + 1}.jpg`);
    STIM_LISTS.airplanes = Array.from({ length: 300 }, (_, i) => `../../pilot-stimuli/airplanes/airplane_${i + 1}.jpg`);
}
const IMAGE_CACHE = {};
