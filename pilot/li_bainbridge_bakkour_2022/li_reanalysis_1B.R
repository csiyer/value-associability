...
m2_right_high.v_ns1 <- glmer(choseright ~ delta.mem * scale(SumValue) + z.delta.value * SumMem +
                            (delta.mem * scale(SumValue) + z.delta.value * SumMem || ID) + (1 | stim_left) +
                            (1 | stim_right),
                          family = "binomial",
                          data = choice.high.v)
m2_right_dv_bin_high.v_ns1 <- glmer(choseright ~ delta.mem * scale(SumValue) + dv_bin * SumMem +
                               (delta.mem * scale(SumValue) + dv_bin * SumMem || ID) + (1 | stim_left) +
                               (1 | stim_right),
                             family = "binomial",
                             data = choice.high.v)
