...
params.instruction_pages = [
    ...
    `<div class='instruction-container' style='max-width: 900px;'>
        ...
        <p>Before we begin, please review the consent form below. You can also download a copy <a href="https://csiyer.github.io/files/online_consent_form.pdf" target="_blank" style="color: ${params.blue_deck_color}; font-weight: bold; text-decoration: underline;">here</a>.</p>
        <iframe src="https://csiyer.github.io/files/online_consent_form.pdf" width="100%" height="600px" style="border: 1px solid #eee; border-radius: 8px; margin-top: 10px;"></iframe>
