#!/usr/bin/env python3
"""Extract non-zero participant bonuses from associability task CSV files.

Usage:
    python associability-task/scripts/extract_bonus.py
    python associability-task/scripts/extract_bonus.py /path/to/data_dir
